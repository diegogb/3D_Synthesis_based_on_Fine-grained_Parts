...
public:
	...
	SymBox3(int numSamples, int numFaces, const Vector3<Real>* samples, const Vector3<Real>* faces, 
		Real epsilon, Query::Type queryType, bool doCalcSym);
	double* CheckSymPlanes(const Vector3<Real>* samples, int ns, const Vector3<Real>* faces, int nf, 
		Vector3<Real>& normal1, Vector3<Real>& point1, Vector3<Real>& normal2, Vector3<Real>& point2, Vector3<Real>& normal3, Vector3<Real>& point3);
	//-----
