...
%%%%%
% This script allows you to generate a new collection of 3D shapes from our input set of Chairs
...
if (exist(mainDir, 'dir'))
    if (exist(fullfile(mainDir, 'synthBasedOnFG-Chairs.mat'), 'file')) && (exist(fullfile(mainDir, 'synthBasedOnFG-ChairsMS.mat'), 'file'))
        ...
        err = fSynthesizeNewShapeCollectionP(segmentsArray, samplingsArray, meshSegments, Dist, segmentsAdj, ...
